...
public class MainActivity extends BaseActivity {
    ...
    private void initNavBar() {
        ...
        BottomNavigationItem item1 = new BottomNavigationItem(R.mipmap.tuan1, "福利");
        BottomNavigationItem item2 = new BottomNavigationItem(R.mipmap.shop1, "Android");
        BottomNavigationItem item3 = new BottomNavigationItem(R.mipmap.me1, "ios");
