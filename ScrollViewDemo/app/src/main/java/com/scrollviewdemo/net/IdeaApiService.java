...
public interface IdeaApiService {
    ...
    @Headers({"Content-Type: application/json", "Accept: application/json"})
    @GET("data/{category}/{pagesize}/{pagenum}")
    Observable<GankGay> getMyincome(@Path("category") String category, @Path("pagesize") String pagesize, @Path("pagenum") int pagenum);
    ...
    @Headers({"Content-Type: application/json", "Accept: application/json"})
    @GET("data/{category}/{pagesize}/{pagenum}")
    Observable<GankGay> getHomeTuiJian(@Path("category") String category, @Path("pagesize") String pagesize, @Path("pagenum") int pagenum);
