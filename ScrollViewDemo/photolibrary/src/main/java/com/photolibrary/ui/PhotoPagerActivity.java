...
import com.photolibrary.Awen;
import com.photolibrary.BaseActivity;
import com.photolibrary.R;
import com.photolibrary.bean.PhotoPagerBean;
import com.photolibrary.controller.PhotoPagerConfig;
import com.photolibrary.util.AppPathUtil;
import com.photolibrary.util.ImageUtils;
import com.photolibrary.util.PermissionUtil;
import com.photolibrary.widget.HackyViewPager;
import com.photolibrary.widget.RoundProgressBar;
import com.photolibrary.widget.photodraweeview.OnViewTapListener;
import com.photolibrary.widget.photodraweeview.PhotoDraweeView;
...
//            hierarchy.setFailureImage(getResources().getDrawable(R.mipmap.failure_image));
            hierarchy.setRetryImage(getResources().getDrawable(R.drawable.take_photo));
    ...
    private void startPermissionSDFaild() {
        new android.app.AlertDialog.Builder(this)
                ...
                }).setPositiveButton(R.string.outling, new DialogInterface.OnClickListener() {
            @Override
            public void onClick(DialogInterface dialog, int which) {
